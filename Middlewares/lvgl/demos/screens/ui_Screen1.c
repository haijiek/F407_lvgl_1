...
void ui_event_Button2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_state_modify(ui_Label2, LV_STATE_CHECKED, _UI_MODIFY_STATE_REMOVE);
    }
}
...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_text_color(ui_Button1, lv_color_hex(0xEE1919), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Button1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Button2 = lv_btn_create(ui_Screen1);
    lv_obj_set_width(ui_Button2, 100);
    lv_obj_set_height(ui_Button2, 50);
    lv_obj_set_x(ui_Button2, -99);
    ...
    lv_obj_set_style_text_color(ui_Label1, lv_color_hex(0xEA1414), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Label1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_Label1, lv_color_hex(0x221010), LV_PART_MAIN | LV_STATE_DEFAULT);
